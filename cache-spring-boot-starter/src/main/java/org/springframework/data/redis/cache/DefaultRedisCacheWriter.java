...
public class DefaultRedisCacheWriter implements RedisCacheWriter {
     ...
     */
    protected DefaultRedisCacheWriter(RedisConnectionFactory connectionFactory, BatchStrategy batchStrategy) {
    ...
    protected <T> T executeLockFree(Function<RedisConnection, T> callback) {
