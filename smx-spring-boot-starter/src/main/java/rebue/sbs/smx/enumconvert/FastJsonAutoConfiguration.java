...
public class FastJsonAutoConfiguration {
    ...
    public HttpMessageConverters customConverters() {
        ...
        // fastJsonConfig.getSerializeConfig().put(BaseEnum.class, new
        // EnumSerializer());

        // fastJsonConfig.getParserConfig().putDeserializer(Enum.class, new
        // EnumExDeserializer());
        // fastJsonConfig.getParserConfig().putDeserializer(BaseEnumBak.class, new
        // EnumExDeserializer());
